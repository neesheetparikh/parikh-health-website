...
export const SERVICES = [
  ...
  },
  {
    ...
    shortDesc: "Concierge-level sports medicine for athletes who demand more.",
    description:
      "Athlete Wellness is our premium, membership-based sports medicine program designed for competitive athletes, serious fitness enthusiasts, and anyone who depends on their body to perform. You get the same direct-access, unhurried care as our concierge medical members — but built entirely around athletic performance, injury prevention, and peak physical function. Dr. Parikh works alongside Miral Patel PT to give you a fully integrated medical and rehabilitation team in your corner.",
    icon: "zap",
    highlights: [
      "Dedicated athlete health panel (labs, metabolic, hormone screening)",
      "Quarterly performance reviews with Dr. Parikh",
      "Priority same-day access for injuries",
      "Integrated care with in-house physical therapy",
      "Return-to-sport planning & clearance",
      "Nutrition & recovery optimization guidance",
      "Direct phone/text access to Dr. Parikh",
    ],
