...
export const TEAM = [
  ...
  },
  {
    ...
    acceptingNewPatients: true,
    bookingUrl: "mailto:mansi@parikhhealth.com",
  },
  {
    id: "miral-patel",
    name: "Miral Patel",
  ...
  },
  {
    ...
    credentials: "PT",
    title: "Physical Therapist",
    bio: "Sonia Sharma is a licensed physical therapist specializing in pelvic floor physical therapy, treating pelvic pain, incontinence, postpartum recovery, and pelvic organ prolapse. She also brings expertise in orthopedic and sports rehabilitation to every treatment plan.",
    image: "/team/sonia-sharma.jpg",
    specialties: ["Pelvic Floor Physical Therapy", "Orthopedic Rehabilitation", "Sports Therapy", "Manual Therapy"],
    acceptingNewPatients: true,
  },
  {
    id: "harshit-bhatwala",
...
export const SUPPORT_STAFF = [
  ...
  { name: "Carina F.", title: "Front Desk", image: "/team/carina-franquez.jpg" },
...
export const SERVICES = [
  ...
  },
  {
    ...
    shortDesc: "Orthopedic, post-operative, and pelvic floor rehabilitation — all in-house.",
    description:
      "Our in-house physical therapy team treats the full range of orthopedic and sports injuries, guides patients through post-operative recovery, and provides pelvic floor physical therapy — all under one roof with your primary care and sports medicine team. Every plan is one-on-one and built around your specific injury, surgery, or goals.",
    icon: "dumbbell",
    highlights: [
      "Orthopedic & sports rehabilitation",
      "Post-operative & post-surgical recovery",
      "Pelvic floor physical therapy",
      "Balance & gait training",
      "Manual therapy & soft tissue techniques",
      "One-on-one, personalized treatment plans",
    ],
    detailHeading: "Conditions & Injuries We Treat",
    conditionsTreated: [
      {
        category: "Orthopedic & Sports Injuries",
        items: [
          "Shoulder pain & rotator cuff injuries",
          "Knee pain & ligament injuries (ACL, MCL)",
          "Low back & neck pain",
      ...
      {
        category: "Post-Operative & Post-Surgical Rehabilitation",
        items: [
          "ACL & other ligament reconstruction",
          "Total knee & hip replacement",
          "Rotator cuff repair",
          "Spine surgery recovery",
          "Fracture rehabilitation",
          "General post-surgical deconditioning",
        ],
      },
      {
        category: "Pelvic Floor Physical Therapy",
        items: [
      ...
      {
        category: "Balance, Gait & General Mobility",
        items: [
          "Balance & fall-risk reduction",
          "Gait training",
          "Chronic pain management",
          "General deconditioning & mobility loss",
        ],
      },
    ],
  ...
  },
  {
    id: "athlete-wellness",
    name: "PitchFit",
    shortDesc: "Elite cricket athlete care, led by USA Cricket's Head Team Physician.",
    description:
      "PitchFit is our membership-based athlete care program, led by Dr. Neesheet Parikh, DO — Head Team Physician for USA Cricket for 6+ years, with over a decade caring for cricketers from junior academies to the national stage. It's built specifically around the physical demands of competitive cricket, drawing on Dr. Parikh's direct experience traveling internationally with the national team and his relationships with medical staff across India, the West Indies, England, Pakistan, and beyond.\n\nMembers get direct cell and email access to Dr. Parikh, same-day and next-business-day visits, full sports physicals, EKG and concussion screening, and injury prevention and return-to-play management — without the delays or denials of traditional insurance billing.\n\nFor the full program, membership tiers, and to apply, visit pitchfit.cricket/elite.",
    icon: "zap",
    highlights: [
